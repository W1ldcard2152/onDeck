...
export const DashboardTaskItem: React.FC<DashboardTaskItemProps> = React.memo(({
  ...
  return (
    <div className={`p-3 md:p-4 rounded-lg border hover:shadow-sm transition-shadow ${getContextColor(task)}`}>
      <div className="flex items-start gap-2 md:gap-3">
        ...
        <button onClick={() => onComplete(task.id)} className="flex-shrink-0 mt-0.5 p-1 md:p-0">
